...
function SelectIdType({ config, t, params, onSelect, refreshPath }) {
  ...
  return (
    <div className="id-verification">
      <FormComposerV2
        ...
        submitInForm
      ></FormComposerV2>
      {showErrorToast && <Toast error={true} label={"Please Select a verification option"} isDleteBtn={true} onClose={closeToast} />}
    </div>
  );
}
