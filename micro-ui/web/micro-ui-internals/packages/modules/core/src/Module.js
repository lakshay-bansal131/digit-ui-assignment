...
import AddressComponent from "./pages/citizen/Login/AddressComponent";
import UploadIdComponent from "./pages/citizen/Login/UploadIdComponent";
import CustomRadioCard from "./pages/citizen/Login/CustomRadioCard";
import AadhaarInput from "./pages/citizen/Login/AadhaarInput";
...
const DigitUIWrapper = ({ stateCode, enabledModules, moduleReducers,defaultLanding }) => {
  ...
  const i18n = getI18n();
  console.debug(initData?.stateInfo?.logoUrl)
  return (
